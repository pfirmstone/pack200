...
import org.apache.harmony.unpack200.UnPack200Archive;

/**
 * Tests for org.apache.harmony.unpack200.UnPack200Archive, which is the main class for
 unpack200.
 */
public class ArchiveTest extends TestCase {
    ...
    public void testWithSql() throws Exception {
        ...
        File compareFile = new File(UnPack200Archive.class.getResource(
    ...
    public void testAlternativeConstructor() throws Exception {
        String inputFile = new File(UnPack200Archive.class
                .getResource("/org/apache/harmony/pack200/tests/sql.pack.gz").toURI()).getPath();
        file = File.createTempFile("sql", ".jar");
        file.deleteOnExit();
        String outputFile = file.getPath();
        UnPack200Archive archive = new UnPack200Archive(inputFile, outputFile);
        archive.unpack();
    }
    ...
    public void testRemovePackFile() throws Exception {
        File original = new File(UnPack200Archive.class.getResource(
    ...
    public void testDeflateHint() throws Exception {
        ...
        file.deleteOnExit();
        out = new JarOutputStream(new FileOutputStream(file));
        archive = new UnPack200Archive(in, out);
